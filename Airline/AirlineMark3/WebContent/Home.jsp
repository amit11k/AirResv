...
<title>Airlines Home Page</title>
<style>
#header {
...
<body>
   ...
   <b1>
	...
	<!-- Put DOmestic & International here  -->
	
	
	<tr><td><input type="text" name="txtForeign"></td></tr>
	<tr><td></td></tr>
	<%-- Put the details for airport list imported from database here <tr>
	<td>
...
%>
 --%>				<tr>
					<td><Label>Departure date: </b></label> <input type="date" name="txtDate" required>

					<!-- Depends on round trip selection <label>Return date: </b></label> <input type="date" name="Return"> --></td>
</tr>
<tr><td>From <input type="text" name="txtFrom"></td></tr>
<tr><td>To <input type="text" name="txtTo"></td></tr>
<tr>
		<td><label>Number of Passengers:</b></label> <select
			id="myListAdulPass" name="txtPass">
		...
		<tr><td></td></tr>
		 <tr><td>
			<label>Choose Flight Class</b></label> <select id="myList" name="txtClass">
