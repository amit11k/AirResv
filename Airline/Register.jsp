...
<body>
	<form method="post">
		<div class="my-container">
            ...
            <div id="header">
               <b1> <b7>Jhantu Airlines sign up </b7></b1>
            </div>
        </div>
		
		<div id="nav">
		    <b4>Back to Jhantu Airlines Homepage </b4><a href="index.jsp">here</a><br>
        ...
        <div class="my-container">
            ...
            <div id="section">
                <b1><b7><center>JOIN jhantu airlines</center></b7>
        		...
        		again as long as you're logged in on our site</b2>
                
                <b3> <br>
        		This form is for customers 13 years or older.<!--  Unnecessary bakkar If you would like to
        		...
        		<b6>
        			...
        			Jhantu terms/conditions and private policy <br>
